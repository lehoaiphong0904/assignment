...
public class StudentListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String sId = s.getId();
                try {
                    deleteStudent("https://pacific-shore-6946.herokuapp.com/students/", sId);
                    setList();
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private void setList() throws Exception {
        JSONArray jArr = new JSONArray(getStudent("https://pacific-shore-6946.herokuapp.com/students.json").toString());
